...
//import static com.strategy.bot.startegy.test.HedgeLimitRsiStrategy.MAP_DATE_TIME_RSI_SMA;
...
//            // MY MAIN ACC
//            "1", Pair.of("6CKgANrPFtih7TAAI4", "lu5WwteC0SOcT5IDgxYC9gMEFCuFONUIbaOR"),
...
//        if (fl) {
//            List<Parameter> parameters1 = parameterService.getParameters(SOL, List.of(1));
//
//            Parameter parameter = parameters1.get(0);
...
//        Double rsiValue = MAP_DATE_TIME_RSI_SMA.get(lastBar.getCreateDate());
...
//            List<Bar> subList = safeGetWindow(i, 19, bars);
//            double rsiValue = Rsi.getValue(subList, 19);
//            MAP_DATE_TIME_RSI_SMA.put(bars.get(i).getCreateDate(), rsiValue);
//        }
//    }
//
